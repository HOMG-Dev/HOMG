...
public class LoadingController : BaseController
{
    ...
    public override void Init()
    {
        ...
        mapModel.cellData[new CellPos(0, 0)]._units.Add(new Unit("大英龙虾兵001", "帝国风暴兵"));
        mapModel.cellData[new CellPos(0, 0)]._units.Add(new Unit("大英龙虾兵002", "帝国风暴兵"));
        mapModel.cellData[new CellPos(0, 0)]._units.Add(new Unit("大英龙虾兵003", "帝国风暴兵"));
    ...
    private void onLoadedEndCallBack(AsyncOperation ao)
    {
        ...
        ApplyControllerFunc(ControllerType.GameUI, EventDefine.OpenMainUIView);
    }
